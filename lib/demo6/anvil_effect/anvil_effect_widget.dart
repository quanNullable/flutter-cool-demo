...
class AnvilEffectWidget extends StatefulWidget {
  ...
  const AnvilEffectWidget({Key key, this.child})
      : assert(child != null),
        super(key: key);
...
class _AnvilEffectWidgetState extends State<AnvilEffectWidget> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    for (int i = 0; i <= 51; i++) {
      ...
      _effectImages.add(Image.asset(
        "assets/image/demo6/wenzi00$str.png",
      ));
    }
      ...
      child: AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget child) {
          ...
          return Stack(alignment: Alignment.center, children: <Widget>[
            Opacity(opacity: tr, child: Transform.translate(offset: transform, child: child)),
