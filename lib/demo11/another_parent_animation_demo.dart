...
class Animation1 extends StatefulWidget {
  @override
  Animation1State createState() => Animation1State();
}

class Animation1State extends State<Animation1> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    parentAnimation = Tween(begin: -0.5, end: 0.0)
        .animate(CurvedAnimation(parent: animationController, curve: Curves.easeIn));
    childAnimation = Tween(begin: 0.0, end: 100.0)
        .animate(CurvedAnimation(parent: animationController, curve: Curves.easeIn));
