...
class Animation3 extends StatefulWidget {
  @override
  State createState() => Animation3State();
}

class Animation3State extends State<Animation3> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animationTitle = Tween(begin: -1.0, end: 0.0)
    ...
    _animationTextField = Tween(begin: -1.0, end: 0.0).animate(CurvedAnimation(
        parent: _animationController, curve: Interval(0.4, 1.0, curve: Curves.fastOutSlowIn)));
    _animationButton = Tween(begin: -1.0, end: 0.0).animate(CurvedAnimation(
        parent: _animationController, curve: Interval(0.6, 1.0, curve: Curves.fastOutSlowIn)));
            ...
            body: SafeArea(
              child: ListView(
                children: <Widget>[
                  ...
                  Transform(
                    transform:
                        Matrix4.translationValues(_animationTextField.value * width, 0.0, 0.0),
                  ...
                  Transform(
                      transform:
                          Matrix4.translationValues(_animationButton.value * width, 0.0, 0.0),
                      child: ButtonBar(
                        children: <Widget>[
                          RaisedButton(
                            onPressed: () {},
