...
class Animation5 extends StatefulWidget {
  @override
  State createState() => Animation5State();
}

class Animation5State extends State<Animation5> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _childAnimation = Tween(begin: 0.0, end: 200.0)
    ...
    return Padding(
      ...
      child: Material(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(filled: true, labelText: labelText, fillColor: Colors.white),
        ),
      ),
    );
  }
