...
class PreviewImageState extends State<PreviewImageWidget> {
  ...
  void reLoadRes() {
    String originImageUrl = "assets/image/test.jpg";
    Future.wait([
      DrawImageUtils.drawMaskImage(
          originImageUrl,
          "assets/image/demo5/" + (currentIndex + 1).toString() + "/frame.png",
          "assets/image/demo5/" + (currentIndex + 1).toString() + "/mask.png",
  ...
  Widget getBottomListView() {
        ...
        itemBuilder: (context, index) {
          Widget imageWidget = new Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image:
                      DecorationImage(image: AssetImage(_listImageIcon[index]), fit: BoxFit.fill)));
    ...
    return new Container(padding: EdgeInsets.all(20), height: 140, child: listView);
  }

  Future<void> _captureImage() async {
    RenderRepaintBoundary boundary = pipCaptureKey.currentContext.findRenderObject();
